...
public interface BookingRepository extends JpaRepository<Booking, UUID> {
     ...
     *
     * Example: if gracePeriodMinutes = 30, expiryThreshold = now - 30 min.
     * Any RESERVED booking whose startTime is before that threshold is expired.
     *
     * NOTE: Uses string literal 'RESERVED' and 'PRE_BOOKING' — these must
     * match BookingStatus and BookingType enum names exactly.
     */
