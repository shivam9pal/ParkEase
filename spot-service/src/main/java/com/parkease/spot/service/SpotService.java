 ...
 *
 * <p>All write methods are @Transactional in the implementation.
 * Status transition methods (reserve/occupy/release) enforce strict
 * state-machine rules — invalid transitions throw IllegalStateException → 409.
 */
public interface SpotService {
    ...
    /** Fetch full spot details by spotId — used by booking-service for pricePerHour. */
    ...
    /**
     * Filter by vehicle type within a lot.
     * Returns ALL statuses — booking-service uses this then checks AVAILABLE.
     */
    ...
    /**
     * Partial update of mutable spot fields.
     * spotNumber and lotId are IMMUTABLE — never changed here.
     */
