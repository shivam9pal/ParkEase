...
/**
 * REST controller for spot-service.
 * All endpoints are versioned under /api/v1/spots.
 *
 * Public endpoints  → no JWT required (guests browse spots)
 * Protected endpoints → JWT required (managers manage, booking-service transitions)
 */
@Slf4j
@RestController
